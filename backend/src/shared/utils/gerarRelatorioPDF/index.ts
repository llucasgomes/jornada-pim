...
export function gerarHtmlRelatorio(data: {
  user: {
    ...
    horarioEntrada: string | null; // era horario_entrada
    horarioSaida: string | null; // era horario_saida
    cargaHorariaDia: number | null; // era carga_horaria_dia
  };
  registros: {
    id: string;
    data: string;
        ...
        <td rowspan="5" style="width:180px;vertical-align:top;padding-left:8px;">
          <div class="horario-box">
            ...
            <table>
              ...
              <tr><td>Segunda</td><td>${user.horarioEntrada ?? "08:00"}</td><td>12:00</td><td>13:12</td><td>${user.horarioSaida ?? "18:00"}</td></tr>
              <tr><td>Terça</td><td>${user.horarioEntrada ?? "08:00"}</td><td>12:00</td><td>13:12</td><td>${user.horarioSaida ?? "18:00"}</td></tr>
              <tr><td>Quarta</td><td>${user.horarioEntrada ?? "08:00"}</td><td>12:00</td><td>13:12</td><td>${user.horarioSaida ?? "18:00"}</td></tr>
              <tr><td>Quinta</td><td>${user.horarioEntrada ?? "08:00"}</td><td>12:00</td><td>13:12</td><td>${user.horarioSaida ?? "18:00"}</td></tr>
              <tr><td>Sexta</td><td>${user.horarioEntrada ?? "08:00"}</td><td>12:00</td><td>13:12</td><td>${user.horarioSaida ?? "18:00"}</td></tr>
              <tr><td>Sábado</td><td>DUNT</td><td>DUNT</td><>DUNT</ td>< td>DUNT</ td></ tr>
            </table>
          </div>
        </td>
      </tr>
